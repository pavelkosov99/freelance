...
@section('content')
    ...
    <form action="{{route('home-page-expert.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="ml-2">
            <x-adminlte-button name="submit" class="btn-flat mt-2 mb-2" type="submit" label="Add a expert" theme="success" icon="fas fa-lg fa-plus"/>
        </div>
    </form>
@stop
